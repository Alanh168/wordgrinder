...
{
	-- E("FEodt",  "O", "Export to ODT...",          nil,         Cmd.ExportODTFileSet),
	-- E("FEhtml", "H", "Export to HTML...",         nil,         Cmd.ExportHTMLFileSet),
	-- E("FEmd",   "M", "Export to Markdown...",     nil,         Cmd.ExportMarkdownFileSet),
	E("FFtxt",  "T", "Export to plain text...",   nil,         Cmd.ExportTextFileSet),
	-- E("FEtex",  "L", "Export to LaTeX...",        nil,         Cmd.ExportLatexFileSet),
	-- E("FEtr",   "F", "Export to Troff...",        nil,         Cmd.ExportTroffFileSet),
	-- E("FEorg",  "E", "Export to Emacs Org...",    nil,         Cmd.ExportOrgFileSet),
--	{"FErtf",  "R", "Export to Rtf...",          nil,         Cmd.ExportRTFFileSet},
})
...
local FileMenu = CreateMenu("File",
{
	...
	M("FF",         "F", "Export current document set >", nil,         ExportSetMenu),
